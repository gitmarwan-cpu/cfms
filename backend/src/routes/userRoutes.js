...
const {
  userGroupIdParamValidation,
  addUserToGroupValidation,
} = require('../validations/userGroupValidation');
...
router.get(
  ...
  authorizePermission('users.view'),
  validate(userIdParamValidation),
  userGroupController.listUserGroups
);

router.post(
  '/:userId/groups',
  authorizePermission('users.manage'),
  validate(addUserToGroupValidation),
...
router.delete(
  '/groups/:userGroupId',
  authorizePermission('users.manage'),
  validate(userGroupIdParamValidation),
