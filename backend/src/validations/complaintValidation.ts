...
const createComplaintValidation = [
  ...
  body('priority').optional({ checkFalsy: true }).custom(isActiveReferenceCode('priority')).withMessage('أولوية الشكوى غير صالحة'),
...
const listComplaintsValidation = [
  ...
  query('priority').optional().custom(isActiveReferenceCode('priority')),
