...
const createGroupValidation = [
  body('code').trim().isLength({ min: 2, max: 60 }).withMessage('كود المجموعة مطلوب').matches(/^[a-z0-9_]+$/).withMessage('كود المجموعة يجب أن يحتوي أحرفاً إنجليزية صغيرة وأرقاماً و _ فقط'),
