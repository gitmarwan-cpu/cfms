...
const listKeyParamValidation = [
  param('key')
    .matches(/^[a-z0-9_]+$/)
    .withMessage('مفتاح القائمة غير صالح'),
];

const itemIdParamValidation = [
  ...listKeyParamValidation,
  param('itemId').isInt({ min: 1 }).withMessage('معرّف العنصر غير صالح'),
];
...
const createItemValidation = [
  ...
  body('code')
    .trim()
    .matches(/^[a-z0-9_]+$/)
    .withMessage('الرمز (code) يجب أن يحتوي أحرفاً إنجليزية صغيرة وأرقاماً وشرطة سفلية فقط'),
